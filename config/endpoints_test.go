...
var _ = Describe("Endpoints", func() {
	DescribeTable("AWSHostToRegion",
		...
		Entry("us-east-1", "https://this-should-default", "us-east-1"),
		Entry("us-east-1", "https://s3.amazonaws.com", "us-east-1"),
		Entry("us-east-1", "https://s3-external-1.amazonaws.com", "us-east-1"),
